export const zhCN = {
  ...
  'dataManager.actions.bulk': '任务操作',
  'dataManager.actions.bulkWithCount': '{count} 项操作',
  ...
  'annotator.messages.noMoreAnnotations': '没有更多可处理的标注任务',
  ...
  'modal.actions.ok': '确认',
  'modal.actions.cancel': '取消',
  'modal.titles.confirm': '操作确认',
  'modal.titles.destructive': '危险操作',
