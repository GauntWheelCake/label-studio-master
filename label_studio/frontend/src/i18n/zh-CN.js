export const zhCN = {
  ...
  'peoplePage.list.role': '角色',
  'peoplePage.list.lastActivity': '最近活动',

  'peoplePage.list.lastActivityEmpty': '暂无记录',
  'peoplePage.roles.annotator': '批注者',
  'peoplePage.roles.reviewer': '审阅者',
  'peoplePage.roles.manager': '管理者',
  'peoplePage.roles.unknown': '未分配',
  'peoplePage.selected.createdProjects': '创建的项目',
  'peoplePage.selected.contributedProjects': '参与的项目',
  'peoplePage.selected.role': '角色',
  'peoplePage.selected.deleteUser': '删除成员',
  'peoplePage.selected.deleteUserConfirmTitle': '确认删除',
  'peoplePage.selected.deleteUserConfirmMessage': '确定要删除该成员吗？此操作无法撤销。',
  'peoplePage.selected.deleteUserConfirmOk': '删除',
  'peoplePage.selected.deleteUserConfirmCancel': '取消',
