export const zhCN = {
  ...
  'dataManager.actions.retrievePredictions.title': '获取预测结果',
  'dataManager.actions.retrievePredictions.dialog': '将所选任务发送到项目已连接的所有机器学习后端。该操作可能因超时而被中断。推荐的方式是使用 Label Studio API 更新任务以获取预测结果。<a href="https://labelstud.io/guide/ml.html">查看文档了解更多信息</a>。请确认继续。',
  'dataManager.actions.deleteTasks.title': '删除任务',
  'dataManager.actions.deleteTasks.dialog': '即将删除所选任务，请确认是否继续。',
  'dataManager.actions.deleteAnnotations.title': '删除标注',
  'dataManager.actions.deleteAnnotations.dialog': '即将删除所选任务的所有标注，请确认是否继续。',
  'dataManager.actions.deletePredictions.title': '删除预测',
  'dataManager.actions.deletePredictions.dialog': '即将删除所选任务的所有预测结果，请确认是否继续。',
